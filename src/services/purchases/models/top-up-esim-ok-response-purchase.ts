...
/**
 * Zod schema for mapping API responses to the TopUpEsimOkResponsePurchase application shape.
...
/**
 * Zod schema for mapping the TopUpEsimOkResponsePurchase application shape to API requests.
