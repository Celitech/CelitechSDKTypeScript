 ...
 * @property {CreatePurchaseV2RequestDuration} - Duration of the package in days. Available values are 1, 2, 7, 14, 30, or 90. Either provide startDate/endDate or duration.
